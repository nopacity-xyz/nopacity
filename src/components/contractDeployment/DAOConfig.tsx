		...
		<>
			...
			<Flex>
				<FormControl>
					...
					<InputGroup size="md">
						<Input pr="4.5rem" type={show ? 'text' : 'password'} placeholder="US Dollar" />
					</InputGroup>
				</FormControl>
				<FormControl>
					<FormLabel htmlFor="password" fontWeight="normal" mt="2%">
					...
					<InputGroup size="md">
						<Input pr="4.5rem" type={show ? 'text' : 'password'} placeholder="USD" />
					</InputGroup>
				</FormControl>
				<FormControl>
					<FormLabel htmlFor="password" fontWeight="normal" mt="2%">
					...
					<InputGroup size="md">
						<Input pr="4.5rem" type={show ? 'text' : 'password'} placeholder="1,000,000" />
					</InputGroup>
				</FormControl>
			</Flex>
		</>
...
export default function DAOConfig() {
